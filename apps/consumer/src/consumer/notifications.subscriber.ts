...
export class NotificationsSubscriber implements OnApplicationBootstrap {
  ...
  constructor(
    ...
    @Inject(CONSUMER_CONFIG) private readonly cfg: ConsumerConfig,
  ...
  async onApplicationBootstrap(): Promise<void> {
    ...
    await channel.addSetup(async (ch: ConfirmChannel) => {
      ...
      await ch.consume(QUEUES.CONSUMER, (msg) => this.onMessage(ch, msg), { noAck: false });
    });
  }
